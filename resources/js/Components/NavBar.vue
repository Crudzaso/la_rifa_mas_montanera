        ...
        <div class="flex items-center space-x-4">
          <template v-if="!auth.user">
            ...
            >
              ...
              <div class="absolute inset-0 bg-[#4F772D]/10 transform -translate-x-full group-hover:translate-x-0 transition-transform duration-300"/>
            </Link>
            <Link
              :href="route('register')"
            ...
            >
              ...
              <div class="absolute inset-0 bg-white/20 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300"/>
            </Link>
          </template>
          ...
          <template v-else>
            <Dropdown align="right" width="48">
              <template #trigger>
                ...
                >
                  <!-- Círculo con inicial -->
                  <div class="relative w-10 h-10 rounded-full bg-gradient-to-br from-[#4F772D] to-[#90A955] flex items-center justify-center transform group-hover:scale-105 transition-all duration-300 shadow-lg">
              ...
              <template #content>
                <div class="bg-white/90 backdrop-blur-md rounded-xl shadow-xl border border-[#4F772D]/20 overflow-hidden">
                  <DropdownLink
